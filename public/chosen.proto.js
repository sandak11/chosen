...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.blur_test = function(evt) {
      if (!this.always_open && !this.active_field && this.container.hasClassName("chosen-container-active")) {
        return this.close_field();
      }
    };
    ...
    Chosen.prototype.choice_destroy = function(link) {
      if (this.result_deselect(link.readAttribute("rel"))) {
        this.show_search_field_default();
        if (!this.always_open && this.is_multiple && this.choices_count() > 0 && this.search_field.value.length < 1) {
          this.results_hide();
        }
        link.up('li').remove();
        return this.search_field_scale();
    ...
    Chosen.prototype.single_set_selected_class = function(item) {
      if (item.classes.length > 0) {
        return this.selected_item.down("span").className = item.classes;
      }
    };
